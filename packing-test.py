...
from DeviceData import DeviceData, clear_saved_data, add_saved_data, get_saved_data
...
class MyTestCase(unittest.TestCase):
    ...
    sleep_memory = bytearray(b'\xc2{"time":1684434908,"pressure":996.116,"temperature":30.4389,"duration":6528,'
